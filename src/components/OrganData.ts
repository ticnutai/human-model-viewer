...
const ORGAN_DETAILS: Record<string, Omit<OrganDetail, "meshName">> = {
  ...
  lung: {
    ...
    summary: "הריאות אחראיות על חילופי גזים — קליטת חמצן ופליטת פחמן דו-חמצני. הן מכילות כ-300 מיליון נאדיות (alveoli) ומחוברות לקנה הנשימה דרך הסמפונות הראשיים.",
    facts: [
      "הריאה הימנית גדולה יותר מהשמאלית — מחולקת ל-3 אונות (העליונה, האמצעית והתחתונה) לעומת 2 בשמאלית",
      "שטח הפנים הכולל של הריאות שווה למגרש טניס (כ-70 מ\"ר)",
      "אנו נושמים כ-20,000 פעמים ביום ומכניסים כ-11,000 ליטר אוויר",
      "הריאות הן האיבר היחיד שיכול לצוף על פני מים בזכות האוויר שבתוכן",
      "כל ריאה מכילה כ-300 מיליון נאדיות (Alveoli) — שלפוחיות זעירות שבהן מתרחש חילוף הגזים",
      "הסמפונות (Bronchi) מתפצלים 23 פעמים עד שמגיעים לנאדיות — כמו ענפי עץ",
      "הריאות מכילות כ-2,400 ק\"מ של דרכי אוויר",
      "הסרעפת (Diaphragma) היא השריר הראשי שמניע את הנשימה — כשהיא מתכווצת, הריאות מתרחבות",
    ],
    system: "מערכת הנשימה", weight: "כ-1.3 ק\"ג (שתיהן)", size: "כ-30 ס\"מ אורך",
    funFact: "אם נפרוש את כל נאדיות הריאה, שטחן יכסה כ-70 מ\"ר — כמגרש טניס",
    ...
    diseaseKeywords: ["קוצר נשימה","אסתמה","שיעול","פנאומוניה","סרטן ריאה","COPD","דלקת ריאות","תסחיף ריאתי","פיברוזיס ריאתי","ברונכיטיס","אמפיזמה","דום נשימה בשינה"],
    quiz: [
      ...
      { question: "איזו ריאה גדולה יותר?", options: ["השמאלית","הימנית","שתיהן שוות","תלוי בגיל"], correct: 1, explanation: "הריאה הימנית גדולה יותר, כי הלב תופס מקום בצד שמאל." },
      ...
      { question: "מהי המחלה COPD?", options: ["מחלת לב","מחלת ריאות חסימתית כרונית","מחלת כליות","מחלת כבד"], correct: 1, explanation: "COPD — Chronic Obstructive Pulmonary Disease — היא מחלה כרונית של דרכי הנשימה הגורמת לקושי בנשימה." },
      { question: "כמה אונות (Lobes) יש בריאה הימנית?", options: ["1","2","3","4"], correct: 2, explanation: "לריאה הימנית 3 אונות (עליונה, אמצעית ותחתונה), ולשמאלית 2 בלבד." },
    ],
    ...
    media: [
      {
        ...
        description: "מבנה הסמפונות וחלוקת הריאות לאונות.",
      },
      {
        title: "המחשת חילוף גזים בריאות",
        type: "video",
        url: "https://www.youtube.com/watch?v=8NUxvJS-_0k",
        description: "סרטון הסבר על מעבר חמצן ופחמן דו-חמצני בנאדיות.",
      },
    ],
  },
  liver: {
    ...
    summary: "הכבד הוא האיבר הפנימי הגדול ביותר בגוף. הוא מבצע מעל 500 תפקידים חיוניים, כולל סינון רעלים, ייצור מרה, אחסון ויטמינים, ויסות רמות סוכר וייצור חלבוני קרישה.",
    media: [
      { title: "מבנה הכבד — ויקיפדיה",  type: "image", url: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Surface_projections_of_the_organs_of_the_trunk.png/800px-Surface_projections_of_the_organs_of_the_trunk.png", description: "הכבד ביחס לאיברי הבטן — אונה ימנית ושמאלית." },
    ...
    facts: [
      "הכבד יכול להתחדש — גם אם מסירים 75% ממנו, הוא חוזר לגודלו המקורי תוך שבועות",
      "הוא מייצר כליטר מרה (Bile) ביום — נוזל ירוק-צהבהב שעוזר לעכל שומנים",
      "הכבד מאחסן ברזל, ויטמין A, D, B12 וגליקוגן (מאגר סוכר)",
      "הוא מקבל דם משני מקורות: וריד השער (Vena portae) ועורק הכבד (Arteria hepatica)",
      "הכבד מכיל כ-100 מיליארד תאים (הפטוציטים — Hepatocytes)",
      "הוא מסנן כ-1.4 ליטר דם בכל דקה — כ-2,000 ליטר ביום",
      "הכבד מייצר אלבומין — החלבון העיקרי בפלזמה, האחראי על לחץ אוסמוטי",
      "הוא מפרק תרופות, אלכוהול ורעלים באמצעות אנזימי ציטוכרום P450",
    ],
    system: "מערכת העיכול", weight: "כ-1.5 ק\"ג", size: "כ-15 ס\"מ רוחב",
    funFact: "הכבד הוא האיבר היחיד בגוף שיכול להתחדש באופן מלא — תכונה שימושית בהשתלות כבד מתורם חי",
    ...
    diseaseKeywords: ["צהבת","סרטן כבד","אבני מרה","דלקת כבד","הפטיטיס A","הפטיטיס B","הפטיטיס C","שחמת כבד","כבד שומני","NAFLD","NASH","אי ספיקת כבד"],
    quiz: [
      ...
      { question: "כמה אחוז מהכבד ניתן להסיר ולחיות אחריו בבטחון?", options: ["10%","25%","50%","75%"], correct: 3, explanation: "הכבד יכול להתחדש גם אחרי הסרת 75% ממנו!" },
      { question: "מהי מרה (Bile)?", options: ["הורמון","נוזל עיכול שמפרק שומנים","סוג של דם","אנזים לבלב"], correct: 1, explanation: "מרה היא נוזל ירוק-צהבהב שמיוצר בכבד ועוזר לפרק שומנים במעי הדק." },
      { question: "מהי הפטיטיס?", options: ["דלקת כבד","סרטן כליה","מחלת ריאות","בעיית עיכול"], correct: 0, explanation: "הפטיטיס (Hepatitis) היא דלקת של הכבד, הנגרמת בדרך כלל על ידי וירוסים (A, B, C) או שימוש יתר באלכוהול." },
      { question: "מהו כבד שומני (NAFLD)?", options: ["סרטן כבד","הצטברות שומן בתאי הכבד","זיהום חיידקי","בעיית מרה"], correct: 1, explanation: "NAFLD — Non-Alcoholic Fatty Liver Disease — הצטברות שומן בכבד שאינה קשורה לאלכוהול, מצב נפוץ מאוד." },
    ],
    wonderNote: "הכבד הוא מעבדה כימית חיה שמבצעת מאות תגובות בו-זמנית — סינון, ייצור, אחסון ופירוק — מורכבות שאין לה מקבילה באיברים אחרים.",
  },
  kidney: {
    name: "הכליות", icon: "🫘",
    latinName: "Ren",
    nameI18n: { he: "הכליות", en: "Kidneys" },
    ta2_id: "A08.1.01.001",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Kidney_Cross_Section.png/800px-Kidney_Cross_Section.png",
    media: [
      { title: "חתך רוחב של כליה", type: "image", url: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Kidney_Cross_Section.png/800px-Kidney_Cross_Section.png", description: "מבנה הכליה: קורטקס (Cortex), מדולה (Medulla), פירמידות כליה ואגן הכליה (Pelvis renalis)." },
      { title: "כיצד הכליות מסננות דם?", type: "video", url: "https://www.youtube.com/watch?v=FN3MFhYjWWo", description: "אנימציה של מסנן הנפרון — יחידת הסינון הבסיסית." },
    ],
    summary: "הכליות מסננות את הדם, מסירות פסולת ומייצרות שתן. הן גם מווסתות לחץ דם, מאזנות אלקטרוליטים, מייצרות אריתרופויאטין (EPO) ומפעילות ויטמין D.",
    facts: [
      "הכליות מסננות כ-180 ליטר דם ביום — רק כ-1.5 ליטר הופכים לשתן",
      "כל כליה מכילה כמיליון נפרונים (Nephrons) — יחידות הסינון הזעירות",
      "אפשר לחיות עם כליה אחת בלבד — הנותרת מגדילה את תפוקתה",
      "הכליות מייצרות הורמון EPO (אריתרופויאטין) שמעודד ייצור כדוריות דם אדומות",
      "הן מפעילות ויטמין D לצורתו הפעילה (Calcitriol) — חיוני לבריאות עצמות",
      "הכליות מקבלות 20-25% מתפוקת הלב, למרות שהן פחות מ-1% ממשקל הגוף",
      "כל נפרון מורכב מגלומרולוס (Glomerulus) — כדורית נימים זעירה — וצינורית ארוכה",
      "מערכת רנין-אנגיוטנסין-אלדוסטרון (RAAS) בכליות מווסתת לחץ דם ונפח נוזלים",
    ],
    ...
    diseaseKeywords: ["אבני כליות","אי ספיקת כליות","לחץ דם גבוה","גלומרולונפריטיס","נפרוזה","פיאלונפריטיס","דיאליזה","השתלת כליה","סוכרת נפרופתיה","כליה פוליציסטית","PKD","זיהום בדרכי השתן"],
    quiz: [
      ...
      { question: "מהו EPO?", options: ["אנזים עיכול","הורמון שמעודד ייצור כדוריות אדומות","סוג של ויטמין","חלבון שריר"], correct: 1, explanation: "EPO (אריתרופויאטין) הוא הורמון שמיוצר בכליות ומעודד את מח העצם לייצר כדוריות דם אדומות." },
      { question: "מהי דיאליזה?", options: ["בדיקת דם","ניתוח כליה","סינון דם מלאכותי כתחליף לכליות","תרופה לכליות"], correct: 2, explanation: "דיאליזה היא טיפול שמסנן את הדם באופן מלאכותי כאשר הכליות אינן מתפקדות כראוי." },
      { question: "מערכת RAAS בכליות אחראית על:", options: ["עיכול מזון","ויסות לחץ דם ונוזלים","ייצור אינסולין","ספיגת סידן"], correct: 1, explanation: "מערכת רנין-אנגיוטנסין-אלדוסטרון (RAAS) מווסתת לחץ דם ונפח נוזלים חוץ-תאיים." },
    ],
    wonderNote: "מיליון נפרונים בכל כליה פועלים כמו מפעל סינון זעיר שמייצר 180 ליטר תסנין ביום — ומחזיר 99% בחזרה לדם.",
  },
  stomach: {
    name: "הקיבה", icon: "🟤",
    latinName: "Gaster (Ventriculus)",
    nameI18n: { he: "הקיבה", en: "Stomach" },
    ta2_id: "A05.5.01.001",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2d/Stomach_diagram_he.svg/800px-Stomach_diagram_he.svg.png",
    media: [
      { title: "דיאגרמת הקיבה", type: "image", url: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2d/Stomach_diagram_he.svg/800px-Stomach_diagram_he.svg.png", description: "אזורי הקיבה: קרדיה (Cardia), פונדוס (Fundus), גוף (Corpus) ופילורוס (Pylorus)." },
      { title: "עיכול מזון בקיבה (וידאו)", type: "video", url: "https://www.youtube.com/watch?v=oHQzAUYEsEc", description: "תהליך העיכול הכימי והמכני — ערבוב, חומצה ואנזימים." },
    ],
    summary: "הקיבה מפרקת מזון באמצעות חומצה הידרוכלורית (HCl) חזקה ואנזים הפרוטאזה פפסין. היא איבר שרירי שמערבב את המזון ומהפך אותו לכימוס (Chyme) — תמיסה חצי-נוזלית.",
    facts: [
      "חומצת הקיבה (HCl) בעלת pH של 1.5-3.5 — חזקה מספיק להמיס מתכת",
      "ריפוד הקיבה (הריירית — Mucosa) מתחדש כל 3-4 ימים כדי למנוע עיכול עצמי",
      "הקיבה מערבבת מזון כ-3 פעמים בדקה בתנועות פריסטלטיקה",
      "מזון שוהה בקיבה 2-5 שעות — שומנים שוהים הכי הרבה זמן",
      "הקיבה מייצרת כ-2 ליטר מיץ קיבה ביום, המכיל HCl, פפסינוגן וריר מגן",
      "גורם פנימי (Intrinsic Factor) שמיוצר בקיבה חיוני לספיגת ויטמין B12 במעי",
      "חיידק Helicobacter pylori חי בסביבה החומצית של הקיבה וגורם לכיבים",
      "הקיבה יכולה להכיל 1-1.5 ליטר מזון, ובמצבים קיצוניים עד 4 ליטר",
    ],
    system: "מערכת העיכול", weight: "ריקה: כ-50 גרם", size: "כ-25 ס\"מ אורך",
    funFact: "הקיבה לא יכולה לעכל את עצמה בזכות שכבת ריר מגנה שמתחדשת כל הזמן — מירוץ חימוש מתמיד",
    ...
    diseaseKeywords: ["כאב בטן","בחילה","צרבת","חומצת הקיבה","כיב קיבה","כיב פפטי","Helicobacter pylori","גסטריטיס","דלקת קיבה","סרטן קיבה","GERD","רפלוקס"],
    quiz: [
      { question: "כמה ליטר מזון הקיבה יכולה להחזיק?", options: ["עד 0.5 ליטר","עד 1 ליטר","עד 1.5 ליטר","עד 3 ליטר"], correct: 2, explanation: "הקיבה יכולה להחזיק עד 1.5 ליטר מזון בממוצע." },
      ...
      { question: "מהו pH של חומצת הקיבה?", options: ["pH 7 (ניטרלי)","pH 5-6","pH 1.5-3.5","pH 10"], correct: 2, explanation: "חומצת הקיבה חומצית מאוד — pH 1.5-3.5, חזקה מספיק להמיס מתכת." },
      { question: "מהו Helicobacter pylori?", options: ["ויטמין","חיידק שגורם לכיבי קיבה","אנזים עיכול","הורמון"], correct: 1, explanation: "H. pylori הוא חיידק שחי בסביבה החומצית של הקיבה ויכול לגרום לכיבים ודלקת." },
      { question: "מהו גורם פנימי (Intrinsic Factor)?", options: ["חומצה","חלבון שחיוני לספיגת B12","אנזים לפירוק שומנים","הורמון"], correct: 1, explanation: "גורם פנימי מיוצר בתאי הקיבה ובלעדיו לא ניתן לספוג ויטמין B12 במעי." },
    ],
    wonderNote: "מירוץ חימוש מתמיד: הקיבה מייצרת חומצה חזקה מספיק להמיס מתכת, ובו-זמנית מחדשת את שכבת הריר שמגנה עליה — כל 3-4 ימים.",
  },
  brain: {
    name: "המוח", icon: "🧠",
    latinName: "Encephalon (Cerebrum)",
    nameI18n: { he: "המוח", en: "Brain" },
    ta2_id: "A14.1.03.001",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Gray728.svg/800px-Gray728.svg.png",
    summary: "המוח הוא מרכז מערכת העצבים המרכזית. הוא שולט בכל תפקודי הגוף — מחשיבה ותנועה ועד נשימה ופעימות לב. מורכב מקליפת המוח (Cortex), גזע המוח (Brainstem) והמוח הקטן (Cerebellum).",
    facts: [
      "המוח מכיל כ-86 מיליארד תאי עצב (נוירונים) וכ-85 מיליארד תאי גלייה תומכים",
      "הוא צורך 20% מהאנרגיה של הגוף, למרות שמהווה רק 2% ממשקלו",
      "מהירות העברת אותות עצביים: עד 120 מ/שנייה (432 קמ\"ש) בסיבים מיאלינים",
      "המוח אינו מרגיש כאב — אין בו נוסיצפטורים (קולטני כאב)",
      "קליפת המוח (Cortex) מחולקת ל-4 אונות: מצחית (Frontal), קודקודית (Parietal), רקתית (Temporal) ועורפית (Occipital)",
      "המוח מכיל כ-160,000 ק\"מ של כלי דם — מספיק להקיף את כדור הארץ 4 פעמים",
      "הסינפסות (נקודות קשר בין נוירונים) מגיעות ל-100 טריליון — יותר מכוכבים בשביל החלב",
      "המוח הקטן (Cerebellum) מכיל 80% מכלל הנוירונים, למרות שהוא רק 10% מנפח המוח",
      "ההיפוקמפוס (Hippocampus) אחראי על זיכרון ולמידה — פגיעה בו גורמת לשכחה",
      "המוח צורך כ-20 וואט חשמל — מספיק להדליק נורה חלשה",
    ],
    system: "מערכת העצבים", weight: "כ-1.4 ק\"ג", size: "כ-15 ס\"מ אורך, נפח כ-1,400 סמ\"ק",
    funFact: "המוח מייצר מספיק חשמל להדליק נורה קטנה — ומעבד מידע מהר פי 10 מכל מחשב-על",
    ...
    diseaseKeywords: ["כאב ראש","מיגרנה","פרקינסון","אלצהיימר","שבץ מוחי","אפילפסיה","טרשת נפוצה","MS","גידול מוחי","מנינגיטיס","דמנציה","ADHD","דיכאון","חרדה","אנצפליטיס"],
    quiz: [
      { question: "כמה נוירונים יש במוח?", options: ["כמיליון","86 מיליארד","1 מיליארד","10 מיליארד"], correct: 1, explanation: "המוח מכיל כ-86 מיליארד תאי עצב (נוירונים)." },
      ...
      { question: "המוח מרגיש כאב?", options: ["כן, הוא רגיש","לא, אין בו קולטני כאב","רק על הפנים","רק כשפצוע"], correct: 1, explanation: "המוח אינו מרגיש כאב כי אין בו נוסיצפטורים (קולטני כאב)." },
      { question: "מהו ההיפוקמפוס?", options: ["שריר במוח","אזור האחראי על זיכרון ולמידה","עצב ראשי","כלי דם מוחי"], correct: 1, explanation: "ההיפוקמפוס (Hippocampus) הוא מבנה במוח האחראי על יצירת זיכרונות חדשים ולמידה." },
      { question: "כמה אונות יש בקליפת המוח?", options: ["2","3","4","6"], correct: 2, explanation: "קליפת המוח מחולקת ל-4 אונות: מצחית, קודקודית, רקתית ועורפית." },
      { question: "מהו שבץ מוחי?", options: ["כאב ראש חזק","חסימה או דימום בכלי דם מוחי","דלקת במוח","גידול"], correct: 1, explanation: "שבץ מוחי נגרם מחסימה (שבץ איסכמי) או דימום (שבץ דימומי) בכלי דם במוח — מצב חירום רפואי." },
    ],
    wonderNote: "רשת עצבית עצומה של 86 מיליארד נוירונים ו-100 טריליון סינפסות מתזמנת חשיבה, רגש ותנועה בזמן אמת — המורכבות הגדולה ביותר ביקום הידוע.",
    media: [
      {
        title: "תרשים אזורי מוח",
        type: "image",
        url: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Gray728.svg/800px-Gray728.svg.png",
        description: "מפת 4 האונות המרכזיות בקליפת המוח.",
      },
      {
  ...
  intestine: {
    ...
    nameI18n: { he: "המעי הדק", en: "Small Intestine" },
    ta2_id: "A05.6.01.001",
    ...
    media: [
      { title: "המעי הדק — איור", type: "image", url: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Small_intestine_%28illustration%29.jpg/800px-Small_intestine_%28illustration%29.jpg", description: "מבנה הסיסים (Villi) לספיגת חומרי מזון." },
    ...
    summary: "המעי הדק (Intestinum tenue) הוא האיבר הארוך ביותר בגוף — כ-6 מטרים. מחולק לשלושה חלקים: תריסריון (Duodenum), ג׳חנון (Jejunum) ומעי עקום (Ileum). כאן מתרחש עיקר הספיגה של חומרי הזנה, ויטמינים ומינרלים.",
    facts: [
      "שטח הפנים של המעי הדק: כ-250 מ\"ר — גודל של מגרש טניס — בזכות הסיסים (Villi) והמיקרוסיסים",
      "המזון עובר דרכו תוך 3-5 שעות בתנועות פריסטלטיקה סדירות",
      "מחולק לתריסריון (Duodenum — 25 ס\"מ), ג׳חנון (Jejunum — 2.5 מ׳) ומעי עקום (Ileum — 3 מ׳)",
      "מכיל מיליוני סיסים (Villi) — כל סיס מכיל נימי דם ולימפה לספיגה",
      "המעי הדק מכיל כ-70% מכלל תאי החיסון בגוף — מערכת GALT (Gut-Associated Lymphoid Tissue)",
      "תאי פנת (Paneth Cells) בתחתית הקריפטות מפרישים ליזוזים וחומרים אנטי-מיקרוביאליים",
      "התריסריון מקבל מרה מכיס המרה ומיץ לבלב מהלבלב — קריטי לפירוק שומנים",
      "מנגנון הספיגה כולל דיפוזיה פשוטה, דיפוזיה מסוייעת, הובלה אקטיבית ואנדוציטוזיס",
    ],
    system: "מערכת העיכול", weight: "כ-2 ק\"ג", size: "כ-6 מטרים אורך, קוטר 2.5-3 ס\"מ",
    funFact: "המעי הדק מכיל יותר תאי חיסון מכל איבר אחר בגוף — הוא קו ההגנה הראשון שלכם",
    ...
    diseaseKeywords: ["כאב בטן","צליאק","מחלת קרוהן","Crohn's","תסמונת המעי הרגיז","IBS","חסימת מעיים","מעי דלקתי","IBD","תת-ספיגה","מלאבסורבציה","אינטוסוסספפציה","גידול במעי דק","אלרגיה למזון","מחלת וויפל"],
    quiz: [
      { question: "כמה מטרים אורך המעי הדק?", options: ["2 מטר","4 מטר","6 מטר","10 מטר"], correct: 2, explanation: "אורך המעי הדק הוא כ-6 מטרים." },
      { question: "כמה עולה שטח הפנים של המעי הדק?", options: ["1 מ\"ר","10 מ\"ר","250 מ\"ר","500 מ\"ר"], correct: 2, explanation: "בזכות הסיסים, שטח הפנים מתרחב לכ-250 מ\"ר — גודל מגרש טניס." },
      { question: "המעי הדק מחולק ל:", options: ["תריסריון ועקום","תריסריון, ג׳חנון ומעי עקום","רק תריסריון","עקום וויל'ון"], correct: 1, explanation: "המעי הדק מחולק לתריסריון (Duodenum), ג׳חנון (Jejunum) ומעי עקום (Ileum)." },
      { question: "מהם הסיסים (Villi)?", options: ["שרירים","בלוטות","בליטות זעירות לספיגה","תאי חיסון"], correct: 2, explanation: "הסיסים הם בליטות זעירות על דופן המעי שמגדילות את שטח הספיגה." },
      { question: "מהי מחלת צליאק?", options: ["אלרגיה לחלב","רגישות לגלוטן שפוגעת בסיסים","זיהום חיידקי","סרטן מעי"], correct: 1, explanation: "צליאק היא מחלה אוטואימונית שבה גלוטן גורם לפגיעה בסיסים של המעי הדק ולתת-ספיגה." },
    ],
    wonderNote: "250 מ\"ר של שטח ספיגה דחוסים ב-6 מטרים של צינור — הנדסה ביולוגית שמאפשרת למצות כל מולקולת מזון.",
  },
  colon: {
    name: "המעי הגס", icon: "🔄",
    latinName: "Colon (Intestinum crassum)",
    nameI18n: { he: "המעי הגס", en: "Large Intestine" },
    ta2_id: "A05.7.01.001",
    ...
    media: [
      { title: "המעי הגס — איור", type: "image", url: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5d/Blausen_0604_LargeIntestine2.png/800px-Blausen_0604_LargeIntestine2.png", description: "מבנה המעי הגס: צֵקוּם, קולון עולה, רוחבי, יורד וסיגמואידי." },
      { title: "תפקוד המעי הגס (וידאו)", type: "video", url: "https://www.youtube.com/watch?v=V_lHMPRMxhI", description: "ספיגת מים, המיקרוביום והכנת הצואה." },
    ],
    summary: "המעי הגס (Colon) סופג מים, אלקטרוליטים וויטמינים (K ו-B12) מהפסולת, ומכיל את אחת המערכות האקולוגיות המורכבות ביותר בטבע — המיקרוביום. הוא מכין את הצואה להפרשה.",
    facts: [
      "אורכו כ-1.5 מטרים וקוטרו כ-6.5 ס\"מ — רחב פי 2.5 מהמעי הדק",
      "מכיל כ-38 טריליון חיידקים — המיקרוביום — שוקלים כ-1.5-2 ק\"ג",
      "המזון שוהה בו 12-36 שעות — הזמן הארוך ביותר במערכת העיכול",
      "מחולק ל: צֵקוּם (Cecum), קולון עולה (Ascending), רוחבי (Transverse), יורד (Descending) וסיגמואידי (Sigmoid)",
      "חיידקי המעי מייצרים ויטמין K (קריטי לקרישת דם) וויטמיני B",
      "התנועות ההאוסטרליות (Haustral contractions) מערבבות ודוחפות את התוכן לאט",
      "ציר מעי-מוח (Gut-Brain Axis): המעי מכיל 500 מיליון נוירונים ומתקשר ישירות עם המוח",
      "סרטן המעי הגס הוא סרטן שכיח מאוד — קולונוסקופיה מומלצת מגיל 45",
    ],
    system: "מערכת העיכול", weight: "כ-1.5 ק\"ג", size: "כ-1.5 מטרים אורך, קוטר 6.5 ס\"מ",
    funFact: "המעי הגס מכיל כ-38 טריליון חיידקים — יותר מכל תאי הגוף יחד!",
    ...
    diseaseKeywords: ["קוליטיס","כאב בטן","עצירות","קוליטיס כיבית","Ulcerative Colitis","מחלת קרוהן","סרטן המעי הגס","פוליפים","דיברטיקוליטיס","תסמונת המעי הרגיז","IBS","שלשול כרוני","דימום רקטלי","מגה-קולון","היצרות מעי"],
    quiz: [
      ...
      { question: "כמה חיידקים יש במעי הגס?", options: ["1 מיליון","1 מיליארד","38 טריליון","100 טריליון"], correct: 2, explanation: "המעי הגס מכיל כ-38 טריליון חיידקים — המיקרוביום." },
      { question: "מהו ציר מעי-מוח?", options: ["עצב בגב","קשר תקשורת בין המעי למוח","כלי דם","שריר"], correct: 1, explanation: "ציר מעי-מוח (Gut-Brain Axis) הוא מערכת תקשורת דו-כיוונית בין המעי הגס והמוח, דרך 500 מיליון נוירונים." },
      { question: "מגיל כמה מומלצת קולונוסקופיה?", options: ["30","35","45","60"], correct: 2, explanation: "קולונוסקופיה מומלצת מגיל 45 לגילוי מוקדם של סרטן המעי הגס." },
    ],
    wonderNote: "38 טריליון חיידקים יוצרים מערכת אקולוגית שלמה בתוך המעי — המיקרוביום משפיע על מצב רוח, חיסון ואפילו משקל.",
  },
  spleen: {
    name: "הטחול", icon: "🟣",
    latinName: "Splen (Lien)",
    nameI18n: { he: "הטחול", en: "Spleen" },
    ta2_id: "A13.1.01.001",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/Spleen_anatomy.jpg/800px-Spleen_anatomy.jpg",
    media: [
      { title: "מבנה הטחול", type: "image", url: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/Spleen_anatomy.jpg/800px-Spleen_anatomy.jpg", description: "אנטומיה של הטחול — לב לבן (White Pulp) ולב אדום (Red Pulp)." },
    ...
    summary: "הטחול (Splen) הוא האיבר הלימפתי הגדול ביותר בגוף. הוא מסנן תאי דם ישנים ופגומים דרך הלב האדום (Red Pulp), מייצר לימפוציטים ונוגדנים בלב הלבן (White Pulp), ומאחסן כ-⅓ מטסיות הדם.",
    facts: [
      "מסנן כ-200 מ\"ל דם בכל דקה — מזהה ומשמיד כדוריות אדומות ישנות (מעל 120 יום)",
      "מאחסן כ-⅓ מכלל טסיות הדם בגוף — משחרר אותן בעת דימום",
      "אפשר לחיות בלעדיו (Asplenia) אך עם סיכון מוגבר לזיהומים חיידקיים מכוסים (Encapsulated bacteria)",
      "הוא האיבר הלימפתי הגדול ביותר — חיוני למערכת החיסונית",
      "הלב הלבן (White Pulp) מכיל לימפוציטים T ו-B שמייצרים נוגדנים (IgM)",
      "הלב האדום (Red Pulp) מפרק המוגלובין ומחזר ברזל לייצור כדוריות חדשות",
      "בזמן פעילות גופנית אינטנסיבית, הטחול מתכווץ ומשחרר דם עשיר בכדוריות אדומות",
      "בעובר, הטחול הוא אתר מרכזי ליצירת תאי דם (Hematopoiesis) — תפקיד שעובר למח העצם אחרי הלידה",
    ],
    system: "מערכת החיסון", weight: "כ-150-200 גרם", size: "כ-12 ס\"מ אורך, 7 ס\"מ רוחב",
    funFact: "בזמן פעילות גופנית, הטחול יכול להתכווץ ולשחרר דם עשיר בתאים אדומים — כמו בנק דם פנימי",
    ...
    kidsFacts: [
      ...
      "💜 הוא נמצא בצד שמאל של הבטן, מתחת לצלעות",
    ...
    diseaseKeywords: ["אנמיה","טחול מוגדל","ספלנומגליה","Splenomegaly","קרע בטחול","אנמיה המוליטית","מונונוקלאוזיס","מלריה","לוקמיה","לימפומה","טרומבוציטופניה","תסמונת אוואנס","היפרספלניזם"],
    quiz: [
      ...
      { question: "אפשר לחיות בלי טחול?", options: ["בילדים בלבד","אי אפשר","כן, בסיכון מוגבר לזיהומים","כן, ללא כל סיכון"], correct: 2, explanation: "אפשר לחיות ללא טחול (Asplenia), אך עם סיכון מוגבר לזיהומים מחיידקים מכוסים." },
      { question: "מהו הלב הלבן (White Pulp)?", options: ["שריר","אזור שמייצר לימפוציטים ונוגדנים","כלי דם","עצב"], correct: 1, explanation: "הלב הלבן מכיל לימפוציטים T ו-B שמייצרים נוגדנים." },
      { question: "כמה דם מסנן הטחול בדקה?", options: ["50 מ\"ל","100 מ\"ל","200 מ\"ל","500 מ\"ל"], correct: 2, explanation: "הטחול מסנן כ-200 מ\"ל דם בכל דקה." },
      { question: "מהי ספלנומגליה?", options: ["דלקת טחול","הגדלת טחול","קרע בטחול","העדר טחול"], correct: 1, explanation: "ספלנומגליה (Splenomegaly) היא מצב של טחול מוגדל, שיכול לנבוע מזיהומים, מחלות דם או גידולים." },
    ],
    wonderNote: "הטחול הוא בנק דם חי: מאחסן טסיות, ממחזר ברזל מכדוריות ישנות ומשחרר רזרבות אדומות בזמן מאמץ — מערכת מיחזור ביולוגית מושלמת.",
  },
  pancreas: {
    name: "הלבלב", icon: "🟡",
    latinName: "Pancreas",
    nameI18n: { he: "הלבלב", en: "Pancreas" },
    ta2_id: "A05.9.01.001",
    ...
    media: [
      { title: "מבנה הלבלב", type: "image", url: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/Blausen_0699_PancreasAnatomy2.png/800px-Blausen_0699_PancreasAnatomy2.png", description: "ראש (Head), גוף (Body) וזנב (Tail) הלבלב, ואיי לנגרהנס (Islets of Langerhans)." },
    ...
    summary: "הלבלב (Pancreas) הוא איבר ייחודי בעל תפקיד כפול: אקסוקריני — מפריש אנזימי עיכול (ליפאז, אמילאז, טריפסין) ובקרבונט לתריסריון; ואנדוקריני — מייצר הורמונים (אינסולין, גלוקגון, סומטוסטטין) דרך איי לנגרהנס.",
    facts: [
      "מייצר כ-1.5 ליטר מיץ לבלב ביום — עשיר באנזימי עיכול ובקרבונט",
      "איי לנגרהנס (1-2 מיליון) מהווים רק 1-2% מנפח הלבלב אך אחראים על כל ההפרשה ההורמונלית",
      "תאי בטא (β) מייצרים אינסולין — מוריד סוכר; תאי אלפא (α) מייצרים גלוקגון — מעלה סוכר",
      "תאי דלתא (δ) מפרישים סומטוסטטין שמווסת את שני ההורמונים",
      "האנזימים מיוצרים בצורה לא-פעילה (זימוגנים) כדי למנוע עיכול עצמי של הלבלב",
      "דלקת לבלב חריפה (Acute Pancreatitis) — הלבלב מתחיל לעכל את עצמו כשהאנזימים מופעלים בטרם עת",
      "סרטן הלבלב הוא מהקשים ביותר לאבחון — לרוב מתגלה בשלב מאוחר",
      "הביקרבונט שמפריש הלבלב מנטרל את חומצת הקיבה בתריסריון — pH עולה מ-2 ל-7",
    ],
    system: "מערכת העיכול / אנדוקרינית", weight: "כ-70-100 גרם", size: "כ-15-25 ס\"מ אורך",
    funFact: "הלבלב מייצר ביקרבונט כדי לנטרל את חומצת הקיבה — הוא שומר על שלום בין הקיבה למעי",
    ...
    diseaseKeywords: ["סוכרת","סוכרת סוג 1","סוכרת סוג 2","דלקת לבלב","Pancreatitis","סרטן הלבלב","אי ספיקת לבלב","Cystic Fibrosis","פיברוזיס ציסטית","היפוגליקמיה","היפרגליקמיה","אינסולינומה","זינגר-אליסון","גלוקגונומה"],
    quiz: [
      { question: "איזה הורמון מיוצר בלבלב?", options: ["אדרנלין","אינסולין","אסטרוגן","דופמין"], correct: 1, explanation: "איי לנגרהנס בלבלב מייצרים אינסולין (תאי β) וגלוקגון (תאי α)." },
      ...
      { question: "מהם איי לנגרהנס?", options: ["כלי דם","אשכולות תאים אנדוקריניים","עצבים","שרירים"], correct: 1, explanation: "איי לנגרהנס הם 1-2 מיליון אשכולות תאים שמייצרים הורמונים — אינסולין, גלוקגון וסומטוסטטין." },
      { question: "מהי דלקת לבלב חריפה?", options: ["זיהום חיידקי","הפעלה מוקדמת של אנזימים שגורמת לעיכול עצמי","סרטן","חסימת מרה"], correct: 1, explanation: "בדלקת לבלב חריפה, האנזימים מופעלים בטרם עת והלבלב מתחיל לעכל את עצמו." },
      { question: "מדוע סרטן הלבלב קשה לאבחון?", options: ["הוא נדיר","אין לו תסמינים מוקדמים","הלבלב קטן מדי","הוא נמצא בגב"], correct: 1, explanation: "סרטן הלבלב לרוב אינו גורם תסמינים בשלב מוקדם ומתגלה רק בשלב מתקדם." },
    ],
    wonderNote: "הלבלב הוא איבר כפול-פנים: מייצר אנזימי הרס (עיכול) ובו-זמנית הורמוני בקרה (אינסולין) — שני תפקידים הפוכים באיבר אחד.",
  },
  bladder: {
    name: "שלפוחית השתן", icon: "💧",
    latinName: "Vesica urinaria",
    nameI18n: { he: "שלפוחית השתן", en: "Urinary Bladder" },
    ta2_id: "A08.3.01.001",
    media: [
      { title: "מבנה שלפוחית השתן", type: "image", url: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/57/Urinary_bladder.svg/800px-Urinary_bladder.svg.png", description: "שריר הגלאי (Detrusor), הטריגונום ופתחי השופכנים והשופכה." },
    ...
    summary: "שלפוחית השתן (Vesica urinaria) היא איבר שרירי חלול שמאחסן שתן שמגיע מהכליות דרך שני שופכנים (Ureters). דופן השלפוחית עשויה משריר הגלאי (Detrusor) שמתכווץ בזמן השתנה. היא יכולה להכיל 400-600 מ\"ל.",
    facts: [
      "תחושת מלאות ראשונה מורגשת בכ-150-200 מ\"ל — דחף חזק בכ-400 מ\"ל",
      "דופן השלפוחית עשויה משריר חלק — שריר הגלאי (Detrusor muscle)",
      "ריפוד פנימי של אפיתל מעבר (Transitional epithelium) שמתרחב כאקורדיון",
      "אנו משתינים כ-6-8 פעמים ביום ומייצרים 1.5-2 ליטר שתן",
      "הטריגונום (Trigone) — משולש בתחתית השלפוחית — הוא האזור הרגיש ביותר",
      "שני סוגרים: פנימי (אינוולונטרי — שריר חלק) וחיצוני (וולונטרי — שריר רצוני)",
      "בלילה, הגוף מפריש ADH (הורמון אנטי-דיורטי) שמרכז את השתן ומפחית נפח — כך ישנים בלי להתעורר",
      "זיהום בדרכי השתן (UTI) הוא מהזיהומים החיידקיים השכיחים ביותר — במיוחד בנשים",
    ],
    system: "מערכת השתן", weight: "ריקה: כ-50-60 גרם", size: "כאגס כשריקה, מתרחבת כבלון",
    funFact: "השלפוחית יכולה להחזיק עד ליטר שתן במצבים קיצוניים — אבל לא מומלץ!",
    ...
    kidsFacts: [
      ...
      "💧 הכליות שולחות אליה שתן דרך צינורות מיוחדים (שופכנים)",
      "📏 היא בגודל של אגס כשריקה",
    ],
    kidsFunFact: "כשאתם ישנים, השלפוחית מתרחבת יותר כדי שלא תצטרכו לקום בלילה — הגוף חכם!",
    kidsEmoji: "🎈",
    cameraPos: [0, -1.0, 2.0], lookAt: [0, -1.0, 0],
    diseaseKeywords: ["זיהום בדרכי השתן","UTI","שלפוחית רגיזה","OAB","אבנים בשלפוחית","סרטן שלפוחית","דליפת שתן","אי-נקיטת שתן","Incontinence","ציסטיטיס","Cystitis","שלפוחית נוירוגנית","רטנציה","עודף ADH","SIADH"],
    quiz: [
      { question: "כמה שתן מייצרים ביום?", options: ["0.5 ליטר","1-1.5 ליטר","1.5-2 ליטר","3 ליטר"], correct: 2, explanation: "הגוף מייצר כ-1.5-2 ליטר שתן ביום." },
      { question: "כמה פעמים משתינים ביום בממוצע?", options: ["2-3","4-5","6-8","10+"], correct: 2, explanation: "בדרך כלל משתינים 6-8 פעמים ביום." },
      { question: "מהו שריר הגלאי (Detrusor)?", options: ["שריר הרגל","שריר דופן השלפוחית","שריר הלב","שריר הסרעפת"], correct: 1, explanation: "שריר הגלאי הוא השריר החלק שיוצר את דופן השלפוחית ומתכווץ בזמן השתנה." },
      { question: "מהו UTI?", options: ["בדיקת דם","זיהום בדרכי השתן","בעיית כליות","הורמון"], correct: 1, explanation: "UTI (Urinary Tract Infection) הוא זיהום חיידקי בדרכי השתן — מהנפוצים ביותר, במיוחד בנשים." },
      { question: "מה תפקיד הורמון ADH בלילה?", options: ["מעיר אתכם","מרכז את השתן כדי שתישנו רצוף","מייצר שתן","מרחיב את השלפוחית"], correct: 1, explanation: "ADH (הורמון אנטי-דיורטי) מרכז את השתן בלילה כדי שנישן ללא הפרעה." },
    ],
    wonderNote: "אפיתל מעבר ייחודי מאפשר לשלפוחית להתרחב פי 5 מגודלה — כמו בלון ביולוגי עם שליטה עצבית מדויקת.",
  },
  bone: {
    name: "העצמות", icon: "🦴",
    latinName: "Ossa (Os)",
    nameI18n: { he: "העצמות", en: "Bones" },
    ta2_id: "A02.0.00.001",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Illu_long_bone.jpg/800px-Illu_long_bone.jpg",
    media: [
      { title: "מבנה עצם ארוכה", type: "image", url: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Illu_long_bone.jpg/800px-Illu_long_bone.jpg", description: "קורטקס (Cortical bone), מח עצם (Bone marrow), אפיפיזה (Epiphysis) ודיאפיזה (Diaphysis)." },
    ...
    summary: "מערכת השלד (Skeletal System) כוללת 206 עצמות אצל מבוגר. העצמות מספקות תמיכה מבנית, מגנות על איברים פנימיים, מאפשרות תנועה, מאחסנות מינרלים (סידן וזרחן) ומייצרות תאי דם במח העצם האדום.",
    facts: [
      "בגוף המבוגר יש 206 עצמות — תינוקות נולדים עם כ-270 שמתאחות בהדרגה",
      "עצמות חזקות פי 4 מבטון ביחס למשקלן — ההנדסה של עצם ספוגית אופטימלית",
      "מח עצם אדום (Red bone marrow) מייצר כ-200 מיליארד כדוריות דם אדומות ביום",
      "עצמות מתחדשות כל הזמן: אוסטיאוקלסטים (Osteoclasts) מפרקים ואוסטיאובלסטים (Osteoblasts) בונים",
      "99% מהסידן בגוף מאוחסן בעצמות — הן בנק מינרלים",
      "העצם הארוכה ביותר: עצם הירך (Femur — 48 ס\"מ); הקטנה: הסנדל באוזן (Stapes — 3 מ\"מ)",
      "עצמות מכילות קולגן (גמישות) והידרוקסיאפטיט (קשיחות) — שילוב שנותן חוזק עם גמישות",
      "חוק וולף (Wolff's Law): עצמות מתעבות באזורים שחווים עומס מכני — הגוף מחזק אותן לפי הצורך",
    ],
    system: "מערכת השלד", weight: "כ-15% ממשקל הגוף (כ-10-12 ק\"ג)", size: "206 עצמות, משתנה",
    funFact: "עצמות חזקות יותר מפלדה ביחס למשקלן — ומתחדשות כל 7-10 שנים",
    ...
    kidsFacts: [
      ...
      "👂 העצם הכי קטנה בגוף נמצאת באוזן — 3 מ\"מ בלבד!",
    ],
    kidsFunFact: "תינוקות נולדים עם יותר עצמות ממבוגרים! חלק מהעצמות מתחברות ביחד כשגדלים.",
    kidsEmoji: "🏗️",
    cameraPos: [0, 0, 4.0], lookAt: [0, 0, 0],
    diseaseKeywords: ["כאב גב","שבר עצם","אוסטיאופורוזיס","Osteoporosis","אנמיה","סרטן עצמות","Osteosarcoma","דלקת מפרקים","ארתריטיס","Arthritis","רככת","Rickets","אוסטיאומיאליטיס","Osteomyelitis","פג'ט","מיאלומה","לוקמיה","גידול עצם"],
    quiz: [
      { question: "כמה עצמות יש למבוגר?", options: ["150","206","270","350"], correct: 1, explanation: "למבוגר יש 206 עצמות." },
      { question: "תינוקות נולדים עם כמה עצמות?", options: ["150","206","270","350"], correct: 2, explanation: "תינוקות נולדים עם כ-270 עצמות; חלקן מתאחדות." },
      { question: "איזו עצם היא החזקה בגוף?", options: ["עצם התנוך","עצם הירך","הגולגולת","עצם הכובד"], correct: 1, explanation: "עצם הירך (Femur) היא החזקה והארוכה ביותר בגוף." },
      { question: "מהי אוסטיאופורוזיס?", options: ["סרטן עצם","דלילות עצם — ירידה בצפיפות","דלקת מפרקים","שבר"], correct: 1, explanation: "אוסטיאופורוזיס היא ירידה בצפיפות העצם שמגבירה סיכון לשברים — שכיחה בנשים אחרי גיל המעבר." },
      { question: "מהו חוק וולף?", options: ["עצמות מתכווצות בקור","עצמות מתעבות באזורי עומס","עצמות גדלות בלילה","עצמות צריכות שמש"], correct: 1, explanation: "חוק וולף (Wolff's Law) קובע שעצמות מתחזקות באזורים שחווים עומס מכני — אימון מחזק עצמות." },
    ],
    wonderNote: "200 מיליארד כדוריות דם חדשות ביום נוצרות במח העצם — מפעל ביולוגי שלא נעצר לרגע לאורך כל החיים.",
  },
  skull: {
    name: "הגולגולת", icon: "💀",
